...
# File: host_agent_adk/host/agent.py
class HostAgent:
    """The Host agent."""
    ...
    def create_agent(self) -> Agent:
        return Agent(
            ...
            description = "This Host agent coordinates with a remote agent to retrieve information based on user queries.",
            tools=[
                self.send_message,
            ],
        )
...
def _get_initialized_host_agent_sync():
    ...
    async def _async_main():
        # Hardcoded URLs for the remote agents
        remote_agent_urls = [
            REMOTE_2_AGENT_URL,  # mongodb_query_agent
        ]
